...
public class L1CostCalculator {
  ...
  static Wei l1CostInBedrock(
    ...
    return l1CostInBedrockProcess(
        tx.getRollupGasData(), l1BaseFee, overhead, l1FeeScalar, isRegolith);
  }
  ...
  static Wei l1CostInEcotone(
    ...
    var calldataGas =
        costData.getZeroes() * TX_DATA_ZERO_COST
            + costData.getOnes() * TX_DATA_NON_ZERO_GAS_EIP2028_COST;
